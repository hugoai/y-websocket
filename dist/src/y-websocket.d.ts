...
export class WebsocketProvider extends Observable<string> {
     ...
     */
    constructor(serverUrl: string, roomname: string, doc: Y.Doc, { connect, awareness, params, WebSocketPolyfill, resyncInterval, maxReconnectRetryCount, disableBroadcastChannel }?: {
        connect?: boolean;
     ...
     * @type {number}
     */
    _maxReconnectRetryCount: number;
    /**
     * @type {boolean}
     */
    _disableBroadcastChannel: boolean;
    /**
